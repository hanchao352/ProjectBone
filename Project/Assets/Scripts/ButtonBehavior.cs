...
{
    public int id;              // 骨骼ID
    public int type;            // 模型数据类型 (EnumBone: Other=0, Bone=1, Muscle=2, Fascia=4)
...
public class ButtonBehavior : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="type">显示类型位组合 (BoneShowType: Bone=1, Muscle=2, Fascia=4, All=7，与 EnumBone 数值一致)</param>
